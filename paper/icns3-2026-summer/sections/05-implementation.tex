...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    \node[stage, below=of runs] (analysis) {%
      \textbf{Analysis and paper artifacts}\\[1pt]
      \SummaryCsv{}, aggregate CSVs, SVG figures, LaTeX tables};
  ...
  \Description{Vertical workflow diagram with five stages: inputs, Python runner, ns-3 benchmark example, run directories, and analysis artifacts; each stage is connected to the next by a downward arrow.}
  \label{fig:workflow}
\end{figure}
