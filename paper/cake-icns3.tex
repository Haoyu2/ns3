...
reproducible Linux validation harness; sources, validation harness and the
committed Linux references are available on the
\texttt{ns3-summer-2026} branch of our repository.\footnote{Guided README:
